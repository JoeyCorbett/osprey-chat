...
const initialMessages = [
  {
    id: 1,
    sender: 'Alice',
    content: 'Hey everyone! Did anyone understand the homework?',
    avatarUrl: '/avatars/alice.png',
  },
  {
    id: 2,
    sender: 'Bob',
    content: "I'm still working on it. Question 3 is tricky.",
    avatarUrl: '/avatars/bob.png',
  },
  {
    id: 3,
    sender: 'You',
    content: 'Yeah, I struggled with that too, but I figured it out!',
